...
Download:
  ...
  -N,  --timestamping              don't re-retrieve files unless newer than local
       --no-if-modified-since      don't use conditional if-modified-since get requests
...
HTTPS (SSL/TLS) options:
       ...
       --pinnedpubkey=FILE/HASHES  Public key file or hashes to verify peer against
       --random-file=FILE          file with random data for seeding the SSL PRNG
       --ciphers=STR               Set the priority string or cipher list string
